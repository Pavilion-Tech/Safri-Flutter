...
class EndPoints {
  ...
  static const String baseUrl = 'https://api.safriapp.com/';
  ...
  static const createSupportChat = "support-chat/create-support-chat";
  static const sendMessage = "support-chat/send-message";
